                ...
                <div className="about__data grid">
                    ...
                    <div className="about__skills grid">
                        ...
                        <div className='flex flex-wrap gap-4'>
                            ...
                            <div className="skills__data">
                                <div className="skills__titles">
                                    <h3 className="skills__name">{t('about.skills.mobile')}</h3>
                                    {/* <span className="skills__number">52%</span> */}
                                </div>
                                {/* <div className="skills__bar">
                                <span className="skills__percentage uiux"></span>
                    ...
                    <div className="about__skills grid">
                        <h2 className="about__skills-title">{t('about.hobby')}</h2>

                        <div className='flex flex-wrap gap-4'>
                            {t('about.hobbies', { returnObjects: true }).map((hobby, index) => (
                                <div className="hobbies__data" key={index}>
                                    <div className="skills__titles hobbies__titles">
                                        <h3 className="hobbies__name">{hobby}</h3>
                                    </div>
                                </div>
                            ))}
                        </div>
